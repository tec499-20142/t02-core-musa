...
\subsection{Visão Geral do Documento}
  ...
  \subsection{Instruções Lógicas}
    ...
    \begin{functional}
      \requirement{Instrução CMP}{O processador deve ser capaz de comparar dois registradores e ativar ou desativar uma flag para sinalizar igualdade.}{Essencial}

      \requirement{Instrução NOP}{Não realiza operação.}{Essencial}
