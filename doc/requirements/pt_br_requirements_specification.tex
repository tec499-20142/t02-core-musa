...
\end{functional}
    ...
    \begin{functional}
      ...
      A instrução BRFL está compreendida da seguinte forma:\\
       \begin{itemize}
         ...
         \item Contante (CST) - constante a qual será comparada com R.
         \end{itemize}
         }
      {Essencial}
    ...
    \begin{functional}
      ...
      {O processador deve ser capaz de avisar que houve um erro (ou um "estouro") na operação aritimética através da flag de overflow.}
      {Essencial}
