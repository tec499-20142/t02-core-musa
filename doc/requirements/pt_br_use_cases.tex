...
\textbf{ALU} – Unidade L\'{o}gica e Aritm\'{e}tica.
  ...
  \begin{mainflow}
    ...
    \item Leitura da instrução apontada por PC;
    \item Acesso aos respectivos registradores;
    \item Controlador direciona os dados dos registradoes para a entrada da ULA;
    \item Controlador envia o function para ativar a operação desejada na ULA;
    \item ULA realiza as operações;
    \item Dispara flags, se for o caso;
    \item Envia o resultado para o registrador de destino;
  \end{mainflow}
  
  \usecase{RET}
  O processador deve ser capaz de retornar do ultimo desvio tomado pelo programa.
  \actors
  \begin{description}
  	\item \textbf{Controlador} – Unidade que controla a execução das operações.
  \end{description}
  ...
  \begin{mainflow}
  	\item Acesso ao PC;
  	\item Leitura da instrução apontada por PC;
  	\item Ler o endereço do topo da pilha;
  	\item Remove o endereço do topo da pilha;
  	\item Incrementa o endereço removido do topo da pilha;
  	\item Modifica o valor do PC para o valor Incrementado;
  \end{mainflow}
  
   \usecase{NOP}
  O processador deve ser capaz de não realizar nenhuma ação durante os cinco ciclos de clock determinado para esta instrução.
  \actors
  \begin{description}
  	\item \textbf{Controlador} – Unidade que controla a execução das operações.
  \end{description}
  ...
  \begin{mainflow}
  	\item Acesso ao PC;
  	\item Leitura da instrução apontada por PC;
  	\item Modifica o valor do PC para o endereço da próxima instrunção.
  \end{mainflow}
