...
\textbf{Controle} – Unidade que controla a execução das operações.
...
\textbf{Registradores de flags} – Registradores de uso específicos para sinalizar resultados re operações.
