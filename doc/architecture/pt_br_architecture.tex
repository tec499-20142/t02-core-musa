  ...
  \begin{table}[ht]
    ...
    \begin{tabular}[pos]{|m{2cm} | m{8cm} | m{4cm}|} 
      ...
      \hline 20/10/2014 &  Concepção do Documento & fmbboaventura \\ \hline
      		 ...
      		 06/11/2014 & Refatoração do documento & jadsonfirmo e KelCarmo \\ \hline
...
\chapter{Visão Geral da Arquitetura}
  ...
  \begin{figure}[H]
	\centering
	\ucdiagram{./pictures/DataPaths/Arquitetura/DataPathFinal.png}
  \end{figure}  
  ...
  \begin{itemize}
	...
	\begin{tabular}{|c|m{6cm}|c|c|}
  	...
  	NOT & Operação lógica NOT. & 000000 & ? \\ \hline
  	CMP & Comparação de dois valores. & 000000 & ? \\ \hline
  	\end{tabular} 
  ...
  \end{table}    
	...
	\begin{tabular}{|c|m{6cm}|c|c|}
  	...
  	SUBi & Subtração de dois valores, sendo um destes imediato. & ? & - \\ \hline
  ...
  \end{table}
	...
	\begin{tabular}{|c|m{6cm}|c|c|}
  	...
  	JPC & Desvia o programa para um endereço relativo ao PC. & ? & - \\ \hline
