...
>>>>>>> f8473d5af3f70ca9976df0c7036649805c3fbab3
    \end{tabular}
  \end{table}
...
\chapter{Visão Geral da Arquitetura}
  ...
  \begin{figure}[H]
	\centering
	\includegraphics{./pictures/DataPaths/Arquitetura/DataPathFinal.png}
  \end{figure}  
...
<<<<<<< HEAD
  	SUBi & Subtração de dois valores, sendo um destes imediato. & 100000 & - \\ \hline
=======
...
<<<<<<< HEAD
  	...
  	JPC & Desvia o programa para um endereço relativo ao PC. & 000011 & - \\ \hline
  	BRFL & Desvia o programa para um endereço de destino, atendendo uma condição de flag. & ? & - \\ \hline
  	CALL & Desvia um programa em execução para uma sub-rotina. & ? & - \\ \hline
  	RET & Retorna de uma sub-rotina. & ? & - \\ \hline
  	HALT & Para a execução de um programa. & ? & - \\ \hline
  	NOP & Não realiza operação. & ? & - \\ \hline
=======
  	JR & Desvia o programa para um endereço de destino. & 000000 & 001000 \\ \hline
  	JPC & Desvia o programa para um endereço relativo ao PC. & 000000 & 001001 \\ \hline
  	...
  	RET & Retorna de uma sub-rotina. & 000000 & 001000 \\ \hline
  	HALT & Para a execução de um programa. & 000000 & 001101 \\ \hline
  	NOP & Não realiza operação. & 000000 & 000000 \\ \hline
>>>>>>> f8473d5af3f70ca9976df0c7036649805c3fbab3
  	\end{tabular} 
  	\caption{Instruções de Load/Store.}
  \end{table}
