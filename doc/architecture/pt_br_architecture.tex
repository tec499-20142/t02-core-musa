...
\chapter{Visão Geral da Arquitetura}
  ...
  \section{Intruções}
  A unidade de processamento possui 21 instruções essenciais para o processamento das operações. Elas são desmembradas em três formatos: R-type, I-type, e Jump.
    ...
    \subsection{Definições de Entrada e Saída}
      ...
      \begin{center}
        \begin{longtable}[pos]{| l | c | c | m{7cm} |} \hline         
          ...
          Function             & 6   & entrada   & Identificador da operação.    \\ \hline
    ...
    \subsection{Definições de Entrada e Saída}
      ...
      \begin{center}
        \begin{longtable}[pos]{| l | c | c | m{7cm} |} \hline         
          ...
          saidaDeDados             & 18   & saída   & Ultimo endereço salvo na pilha para retorno do PC.    \\ \hline
        \end{longtable}
      \end{center}  
