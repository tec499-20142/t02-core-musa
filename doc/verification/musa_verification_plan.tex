...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  \end{table}  
	...
	\begin{itemize}
  		...
  		\item As entradas para DUT são os impulsos gerados no testbenches. Os estímulos são normalmente gerados em um um bloco sempre processual na inicial ou \textit{testbench}.
